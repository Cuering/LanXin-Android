...
│   ├── voice/              离线 ASR ✅ 6.4/P0 · TTS ✅ M1 stub + P1 OfflineTts
│   ├── pet/                桌宠悬浮 + VoiceSession ✅ M1 · 路径 ✅ M2a · L2D 壳 ✅ M2b · 表情 ✅ 打磨
...
| `builtin/voice/` | ✅ 6.4 ASR + P0 sherpa AAR · ✅ M1 TTS stub + **P1 OfflineTts 真引擎** | 高 | Sherpa-ONNX ASR/TTS（模型外置；见 voice-asr / voice-tts） |
...
| 语音 / 桌宠 | — | ✅ 6.4/P0 ASR · ✅ P1 TTS OfflineTts · ✅ M1/M2a/M2b 桌宠 |
...
| `builtin/voice/README.md` | 语音模块（ASR + TTS） | ✅ 6.4/P0 · ✅ M1 · ✅ P1 |
| `docs/meiju-style-pet.md` | 妹居风格桌宠架构对照 + VoiceSession | ✅ M1 · ✅ M2a · ✅ M2b · ✅ 表情打磨 |
| `docs/debug-assets.md` | Debug 开源 Live2D/ASR/TTS：App 内下载+镜像 / 脚本备用 | ✅ M1 · ✅ M2a · ✅ M2b · ✅ 表情 · ✅ 一键下载 |
| `builtin/pet/README.md` | 桌宠模块说明 | ✅ M1 · ✅ M2a · ✅ M2b · ✅ 表情打磨 |
...
- ✅ TTS 接口 + StubTtsEngine（M1）+ **P1 Sherpa OfflineTts 真引擎**（`docs/voice-tts.md`）
...
#### Phase 6 桌宠语音会话 M1 ✅ / M2a ✅ / M2b ✅ / 表情打磨 ✅（`feat/m2b-pet-expression-polish`）
...
| 语音 | 复用 6.4/P0 ASR；`TtsEngine` + `SherpaTtsEngine`（P1，stub 降级） |
...
| M2b 打磨 | `PetExpressionController` + `SET_EXPRESSION` / 口型；缺资源引导；悬浮 `onDestroy` 复位会话 |
| 下一刀 | M4 自有 L2D · M5 场景 · Chat 按住说话 |
| Debug 资源 | App 内一键下载 + 国内镜像；`docs/debug-assets.md`；脚本可选（开源栈，不进 git） |
...
| VoiceRepo / ASR + TTS | **Phase 6.4~6.5 / P0–P1** | Sherpa-ONNX ASR + OfflineTts（会话优先桌宠） |
