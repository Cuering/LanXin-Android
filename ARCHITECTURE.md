...
> 当前状态：**Phase 1 ✅ → Phase 2 ✅ → Phase 3 ✅ → Phase 4 ✅ → Phase 5.1–5.7 ✅ → Phase 6.1 ✅ → Phase 6.2 ✅ → Phase 6.3 ✅ → Phase 6.4 🚧**
> - Step①~⑧ 全部完成
...
│   └── voice/              离线 ASR（Sherpa-ONNX 骨架）🚧 6.4
│
...
| `builtin/voice/` | 🚧 6.4 ASR 骨架 · 🔜 6.5 TTS | 高 | Sherpa-ONNX ASR + Bert-VITS2 TTS（见第十四节） |
...
| `builtin/voice/README.md` | 语音模块说明 | 🚧 6.4 |
...
- 🚧 Sherpa-ONNX（离线语音识别骨架，Phase 6.4）
