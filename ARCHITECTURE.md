...
> 当前状态：**Phase 1 ✅ → Phase 2 ✅ → Phase 3 ✅ → Phase 4 ✅ → Phase 5.1–5.7 ✅ → Phase 6.1 ✅ → Phase 6.2 ✅ → Phase 6.3 ✅ → Phase 6.4 ✅ 骨架 → 桌宠 M1 ✅ → M2a ✅ → M2b Live2D 壳 ✅ → M2b 打磨 表情/口型 ✅（本 PR）** → **Phase 7.1 系统工具骨架 ✅ → 7.2 日历+闹钟 ✅ → 7.3 笔记 ✅ → 7.4 用户文件 ✅ → 7.5 对话/桌宠一体 ✅** · **桌宠 + 操控手机 = 陪伴操控一体**
> - Step①~⑧ 全部完成
...
| `docs/debug-assets.md` | Debug 开源 Live2D/ASR/TTS 路径与脚本 | ✅ M1 · ✅ M2a · ✅ M2b · ✅ 表情打磨 |
