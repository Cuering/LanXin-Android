...
> 当前状态：**Phase 1 ✅ → Phase 2 ✅ → Phase 3 ✅ → Phase 4 ✅ → Phase 5.1–5.7 ✅ → Phase 6.1 ✅ → Phase 6.2 ✅ → Phase 6.3 ✅ → Phase 6.4 ✅ 骨架 → 桌宠 M1 ✅ → M2a 路径闭环 🚧** → **Phase 7.1 系统工具骨架 ✅ → 7.2 日历+闹钟 ✅ → 7.3 笔记 🚧** · **桌宠 + 操控手机 = 陪伴操控一体**
> - Step①~⑧ 全部完成
...
> - Phase 7.3：应用内笔记 Room CRUD + SAF 导出/导入 🚧（`feat/phase7.3-notes`）
...
│   └── systemtools/        系统能力（日历/闹钟/笔记/用户文件）🚧 Phase 7.3
│
...
| 语音 / 桌宠 | — | ✅ 6.4 ASR · 🚧 M1 桌宠 VoiceSession · 🔜 真 TTS/L2D |
...
| `docs/dynamic-plugins.md` | 动态插件包格式与加载流程 + 管理 UI + 市场 + 签名 | ✅ 5.3–5.6 |
...
| `docs/meiju-style-pet.md` | 妹居风格桌宠架构对照 + VoiceSession | ✅ M1 · 🚧 M2a |
| `docs/debug-assets.md` | Debug 开源 Live2D/ASR/TTS 路径与脚本 | ✅ M1 · 🚧 M2a |
| `builtin/pet/README.md` | 桌宠模块说明 | ✅ M1 · 🚧 M2a |
...
| **6.6 / M2** | 路径就绪 + Live2D 真显 + 引擎可接 | 🔴 高 | 3d | 🚧 M2a（#49 / `feat/phase6-pet-m2-engines`） |
...
| 下一刀 | M2b Live2D 真显示 · M2c sherpa 可 load · M3 真 TTS · M4 自有 L2D · M5 场景 |
