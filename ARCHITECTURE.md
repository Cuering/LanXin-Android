...
| `builtin/pet/` | 🚧 M1 桌宠语音会话 | 高 | 悬浮 WebView + VoiceSession 主线（见第十四节） |
...
| `docs/meiju-style-pet.md` | 妹居风格桌宠架构对照 + VoiceSession | 🚧 M1 |
| `builtin/pet/README.md` | 桌宠模块说明 | 🚧 M1 |
| `docs/debug-assets.md` | Debug：免费 Live2D + 开源 ASR/TTS 下载约定 | ✅ |
...
| 下一刀 | M2 真 ASR · M3 真 TTS+口型 · M4 自有 L2D · M5 场景感知 |
| Debug 资源 | `docs/debug-assets.md` + `scripts/download-debug-assets.sh`（开源栈，不进 git） |
