...
class SettingDataSourceImpl @Inject constructor(
    ...
    private val apiStatusMap = mapOf(
        ...
        ApiType.LANXIN to booleanPreferencesKey("lanxin_status")
    )
    private val apiUrlMap = mapOf(
        ...
        ApiType.LANXIN to stringPreferencesKey("lanxin_url")
    )
    private val apiTokenMap = mapOf(
        ...
        ApiType.LANXIN to stringPreferencesKey("lanxin_token")
    )
    private val apiModelMap = mapOf(
        ...
        ApiType.LANXIN to stringPreferencesKey("lanxin_model")
    )
    private val apiTemperatureMap = mapOf(
        ...
        ApiType.LANXIN to floatPreferencesKey("lanxin_temperature")
    )
    private val apiTopPMap = mapOf(
        ...
        ApiType.LANXIN to floatPreferencesKey("lanxin_top_p")
    )
    private val apiSystemPromptMap = mapOf(
        ...
        ApiType.LANXIN to stringPreferencesKey("lanxin_system_prompt")
    )
