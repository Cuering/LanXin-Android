...
LanXin is an Android AI assistant app supporting multiple AI providers (OpenAI, Anthropic, Google, Groq, Ollama, OpenRouter). Built with Kotlin, Jetpack Compose, MVVM architecture, and Hilt DI. Package namespace: `com.lanxin.android`.
...
./gradlew test --tests "com.lanxin.android.ExampleUnitTest"

# Run a single test method
./gradlew test --tests "com.lanxin.android.ExampleUnitTest.addition_isCorrect"

# Instrumented tests (requires device/emulator)
./gradlew connectedAndroidTest

# Run single instrumented test
./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.lanxin.android.ExampleInstrumentedTest
...
5. Project imports (`com.lanxin.android.*`)
6. Java stdlib (`java.*`)
7. Javax (`javax.*`)
